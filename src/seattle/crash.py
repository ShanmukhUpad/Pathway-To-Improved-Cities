...
CITY_NAME  = "Seattle"
MAP_CENTER = {"lat": 47.6062, "lon": -122.3321}
MAP_ZOOM   = 10
LAT_MIN, LAT_MAX = 47.49, 47.74
LON_MIN, LON_MAX = -122.45, -122.23
GEO_URL    = "https://raw.githubusercontent.com/seattleio/seattle-boundaries-data/master/data/neighborhoods.geojson"
GEO_ID_FIELD = "name"
# ─────────────────────────────────────────────────────────────────────────────
